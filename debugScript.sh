...
hostname="tv" && export hostname

username="t" && export username
userpass="t" && export userpass

rootpass="t" && export rootpass
...
# echo "unmount /mnt && exit script in 30 second"
